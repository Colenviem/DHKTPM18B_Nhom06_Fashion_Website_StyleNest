...
const Checkout = () => {
  ...
  const handleCheckout = () => {
    alert("Chức năng 'Đặt hàng' (demo)");
  };
  
  const handleAddNewAddress = () => {
    alert("Chức năng 'Thêm địa chỉ' (demo)");
    setShowNewAddressModal(false);
  };
  ...
  const handleSaveEditAddress = () => {
     alert("Chức năng 'Lưu' (demo)");
     setEditingAddressId(null);
  }

  const handleDeleteAddress = (addrId, e) => {
    e.stopPropagation();
    alert("Chức năng 'Xóa' (demo)");
  };
  
  const setAddressAsDefault = (addressId, e) => {
     e.stopPropagation();
     alert("Chức năng 'Thiết lập mặc định' (demo)");
  }
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex items-center justify-center p-6">
      <div className="bg-white border border-gray-300 rounded-lg shadow-xl w-full max-w-7xl font-['Roboto'] space-y-6 overflow-hidden">
        <div className="px-6 py-4">
          <div className="flex items-start gap-4">
            <FiMapPin className="text-red-500 h-6 w-6 mt-1 animate-pulse" />
              ...
              {selectedAddress ? (
                <div className="flex justify-between items-center pt-2">
                  ...
                  <div className="flex gap-4">
                    ...
                    <button 
                      className="text-gray-600 font-medium hover:text-red-500 transition-colors duration-200" 
        ...
        <div className="px-6 py-4 grid grid-cols-12 gap-4 items-center">
          ...
          <div className="col-span-9">
            <input
              type="text"
              className="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-red-500 focus:ring-2 focus:ring-red-200 transition-all duration-200"
          ...
          <div className="col-span-7 space-y-4">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1 flex items-center">
                ...
                <FiInfo className="h-4 w-4 ml-1 text-gray-800" />
              </p>
            </div>
            <div className="mt-2">
              <p className="text-sm">
                ...
                <br />
                <button className="text-teal-500 font-medium inline-flex items-center mt-2 hover:text-teal-600">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              {["credit", "googlepay", "cod"].map((method) => (
                <button
                  key={method}
                  className={`border rounded px-4 py-2 text-sm transition-all duration-200 hover:scale-105 ${selectedPaymentMethod === method ? "border-red-500 text-red-500" : "hover:border-blue-500"}`}
        ...
        <div className="px-6 py-4 flex justify-between items-center text-sm text-gray-600">
          ...
          <button 
            className="bg-red-500 hover:bg-red-600 text-white font-medium py-3 px-4 rounded transition-all duration-200 hover:scale-105 hover:shadow-lg"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center font-['Rboto']">
          ...
          <div className="relative bg-white border border-gray-200 p-6 rounded-2xl shadow-2xl w-full max-w-3xl mx-4 z-10 animate-scaleIn">
            ...
            <div className="space-y-4 max-h-[500px] overflow-y-auto pr-1 custom-scroll">
                  ...
                  <div className="flex justify-between items-start gap-4">
                    {editingAddressId === addr.id ? (
                      <div className="flex-1 space-y-3">
                        <input
                          type="text"
                          className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-200"
                          value={editForm.name}
                        ...
                        <div className="flex gap-3 pt-1">
                          <button
                            className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md transition-all duration-200 hover:scale-105"
                    ...
                    <div className="flex flex-col items-end text-sm">
                      {addr.isDefault ? (
                        ...
                        <button
                          className="text-blue-600 border border-blue-500 px-3 py-2 rounded hover:bg-blue-50 mb-4 text-xs transition-all duration-200 hover:scale-105"
              ...
              <button
                className="w-full border-2 border-dashed border-gray-300 rounded-xl p-4 flex items-center justify-center text-blue-600 hover:border-blue-400 hover:bg-blue-50 transition-all duration-200 hover:scale-[1.02]"
            ...
            <div className="mt-8 flex justify-end gap-4">
              ...
              <button
                className="bg-red-500 text-white px-6 py-2 rounded-lg hover:bg-red-600 transition-all duration-200 hover:scale-105 hover:shadow-lg"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center font-['Roboto']">
          ...
          <div className="relative bg-white border border-gray-300 p-6 rounded-xl shadow-xl w-full max-w-3xl mx-4 animate-scaleIn z-10">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <input
                    ...
                    className="w-full border border-gray-300 rounded px-4 py-3 transition-all duration-200 focus:border-red-500 focus:outline-none focus:ring-2 focus:ring-red-200"
                  />
                </div>
                <div>
                  <input
              ...
              <div>
                <div className="relative">
                  <select
                    ...
                    onChange={handleNewAddressChange}
                    className="w-full border border-gray-300 rounded px-4 py-3 appearance-none transition-all duration-200 focus:border-red-500 focus:outline-none focus:ring-2 focus:ring-red-200"
                  >
              ...
              <div>
                <textarea
                  ...
                  className="w-full border border-gray-300 rounded px-4 py-3 h-24 transition-all duration-200 focus:border-red-500 focus:outline-none focus:ring-2 focus:ring-red-200"
                ></textarea>
              </div>
            ...
            <div className="mt-6 flex justify-end">
              ...
              <button className="bg-red-500 text-white px-4 py-2 rounded transition-all duration-200 hover:bg-red-600 hover:scale-105" onClick={handleAddNewAddress}>
                Hoàn thành
              </button>
            </div>
          </div>
