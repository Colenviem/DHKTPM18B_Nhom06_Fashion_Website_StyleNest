...
import { FiCheckCircle, FiXCircle, FiStar, FiEdit, FiSearch, FiPlus } from 'react-icons/fi'; 
...
    _id: "BR001",
    name: "Adidas",
    logoUrl: "https://placehold.co/60x60/000000/FFFFFF/png?text=AD",
    description: "Thương hiệu đồ thể thao và phong cách sống hàng đầu thế giới.",
    isFeatured: true,
    isActive: true,
...
    _id: "BR002",
    name: "Nike",
    logoUrl: "https://placehold.co/60x60/FF0000/FFFFFF/png?text=NI",
    description: "Công ty đa quốc gia thiết kế, phát triển và bán giày dép, quần áo.",
    isFeatured: true,
    isActive: true,
...
    _id: "BR003",
    name: "Uniqlo",
    logoUrl: "https://placehold.co/60x60/6366F1/FFFFFF/png?text=UQ",
    description: "Thương hiệu bán lẻ quần áo Nhật Bản, tập trung vào LifeWear.",
    isFeatured: false,
    isActive: true,
...
    _id: "BR004",
    name: "Samsung",
    logoUrl: "https://placehold.co/60x60/3B82F6/FFFFFF/png?text=SS",
    description: "Tập đoàn đa quốc gia chuyên về điện tử tiêu dùng và thiết bị.",
    isFeatured: false,
    isActive: false, 
...
            <h1 className="text-3xl font-semibold text-gray-900 mb-6">Danh sách Thương hiệu</h1>
...
                                            onError={(e) => { e.target.onerror = null; e.target.src = "https://placehold.co/32x32/E0E0E0/333333?text=B" }}
                                        />
                                        <div>
                                            <div className="font-semibold text-gray-800">{brand.name}</div>
                                            <div className="text-xs text-gray-500 font-mono">{brand._id}</div>
                                        </div>
                                    </div>
                                </td>
                                
                                <td className="px-6 py-4 text-gray-700 max-w-xs truncate" title={brand.description}>
                                    {brand.description}
                                </td>
                                
                                <td className="px-6 py-4 text-center whitespace-nowrap">
                                    {brand.isFeatured ? (
                                        <FiStar className="w-5 h-5 text-yellow-500 mx-auto" title="Nổi bật" />
                                    ) : (
...
                                <td className="px-6 py-4 text-center whitespace-nowrap">
                                    {brand.isActive ? (
                                        <FiCheckCircle className="w-5 h-5 text-green-500 mx-auto" title="Đang hoạt động" />
                                    ) : (
...
                                    Không tìm thấy thương hiệu nào phù hợp với từ khóa "{searchTerm}".
                                </td>
                            </tr>
                        )}
                    </motion.tbody>
