          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div className="relative">
              <input
                ...
                placeholder=" "
              />
              <label className="absolute left-0 top-3 text-gray-500 text-base transition-all duration-300 peer-placeholder-shown:top-3 peer-placeholder-shown:text-base peer-focus:-top-4 peer-focus:text-sm peer-focus:text-[#6F47EB]">
                Tên đăng nhập
              </label>
            </div>
